...
Seriously though, the configuration is pretty straightforward and shouldn't prove to be too much of a burden. To start things off, you should configure your data sources and AWS buckets:

h2. Data Sources and AWS Targets

When backing up, your source is a SQL Server instance and your destination is a file on Amazon S3. When restoring, your source is a file on Amazon S3 and your destination is a SQL Server instance.
...
Of the above configuration attributes, @awsPrefix@, @restoreCatalogName@ and @restorePath@ are optional. Note that @catalogName@ refers to the first part of the actual backup file name on S3 in the case of a restore target.
