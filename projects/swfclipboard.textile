...
The answer: *Flash!* It's fun to loathe Flash, but sometimes it solves the problem you need solved. I needed a nice, clean way to provide *~1,000* clipboard targets on a page. You might only need to provide one. Either way, SWFClipboard has got your back.

Okay, so let's jump straight into some code samples and live demos:
...
<script src="http://gist.github.com/576733.js?file=swfclipboard-01.js"></script>
...
<script src="http://gist.github.com/576733.js?file=swfclipboard-02.js"></script>
...
<script src="http://gist.github.com/576733.js?file=swfclipboard-03.js"></script>
...
<script src="http://gist.github.com/576733.js?file=swfclipboard-04.js"></script>

"back to top":#top

You can browse or clone the repository from "http://github.com/ChadBurggraf/swfclipboard":http://github.com/ChadBurggraf/swfclipboard. Or just grab a release from "http://github.com/ChadBurggraf/swfclipboard/downloads":http://github.com/ChadBurggraf/swfclipboard/downloads.
